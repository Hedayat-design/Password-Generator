    ...
    if length.get().isdigit():                                           # length should be in digit form
        ...
        if l>=5 and l<=50:                                               # length should be in given range
            ...
            if complexity.get() != "None":                               # radio box should be selected
                ...
                rr.geometry("500x100")
                rr.config(bg="black")
                label=tkinter.Label(rr,text=password,bg="black",fg="white",font=("Cascadia Code ExtraLight",15,"bold","italic"))
                label.pack(pady=20)
                #rr.mainloop()
...
heading=tkinter.Label(text="Password\nGenerator",bg="black",fg="white",font=("Cascadia Code ExtraLight",15,"bold","italic"),padx=10)      # heading
heading.pack(anchor="nw",padx=10,pady=10)

                                    # frame f1 for length stringvar, entry widget #
                                    #=============================================#
f1=tkinter.Frame(r,bg="white")
length=tkinter.StringVar()                           # tkinter string variable

t=tkinter.Label(f1,text="Password Length",fg="black",bg="white",font=("Cascadia Code ExtraLight",12,"bold"))          # label
t.grid(row=0,column=0,padx=5)

lengthentry=tkinter.Entry(f1,text=length,bg="black",fg="white",font=("Cascadia Code ExtraLight",10,"bold"),justify="center")      # entry widget iniliaze length value to its text
lengthentry.grid(row=0,column=1,padx=5)

t1=tkinter.Label(f1,text="",font=("Ariel",7),bg="white",fg="black")                     # label to print all types of error messages related to length of password
...
f2=tkinter.Frame(r,bg="white")
complexity=tkinter.StringVar()                          # tkinter string variable
complexity.set(None)

radio1=tkinter.Radiobutton(f2,text="Weak",fg="black",bg="white",font=("Cascadia Code ExtraLight",10,"bold"),variable=complexity,value="weak")     # radio button 1
radio1.grid(row=0,column=1)

radio2=tkinter.Radiobutton(f2,text="Moderate",fg="black",bg="white",font=("Cascadia Code ExtraLight",10,"bold"),variable=complexity,value="moderate") # radio button 2
radio2.grid(row=0,column=2)

radio3=tkinter.Radiobutton(f2,text="Strong",fg="black",bg="white",font=("Cascadia Code ExtraLight",10,"bold"),variable=complexity,value="strong")     # radio button 3
radio3.grid(row=0,column=3)

f2.pack()

complexmsg=tkinter.Label(r,text="",font=("Ariel",7),bg="white",fg="black")            # label to print all types of messages related to radio button
complexmsg.pack()


                                   # f3 frame for buttons #
                                   #======================#
f3=tkinter.Frame(r,bg="white")

b=tkinter.Button(f3,text="Generate",bg="black",fg="white",font=("Cascadia Code ExtraLight",9,"bold"),command=click)     # button to generate password 
b.grid(row=0,column=0,padx=5)
b1=tkinter.Button(f3,text="Quit",bg="black",fg="white",font=("Cascadia Code ExtraLight",9,"bold"),command=quit)         # button to quit the program
